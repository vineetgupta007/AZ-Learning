...
$URIForApplicationPermissionCall = "https://graph.microsoft.com/v1.0/security/secureScores"
#$ApplicationPermissions = "SecurityEvents.Read.All Directory.Read.All Sites.Manage.All"
$ApplicationPermissions = "Policy.ReadWrite.ConditionalAccess Policy.Read.All Directory.Read.All Application.Read.All Group.Read.All Group.ReadWrite.All Directory.ReadWrite.All"
$DelegatedPermissions = "Agreement.Read.All"
#$ApplicationPermissions = "Policy.ReadWrite.ConditionalAccess Policy.Read.All Directory.Read.All Application.Read.All SecurityEvents.Read.All SecurityEvents.ReadWrite.All"
...
Connect-AzureAD -TenantId 5d368771-c3cd-48f2-9065-65e899f8ca0d
...
if ($graphsp) {
    ...
    $tokenEndpointUri = "$authority/oauth2/token?api-version=1.0"
	...
	#$content = "grant_type=client_credentials&client_id=$client_id&client_secret=$client_secret&resource=$resource"
	$content = @{ grant_type = "client_credentials"; resource = $resource; client_id = $client_id; client_secret = $client_secret }
